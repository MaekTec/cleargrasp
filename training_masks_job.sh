...
#SBATCH -J cleargrasp_training_masks # sets the job name. If not specified, the file name will be used as job name
...
cd /home/kaeppelm/depth-via-interaction/cleargrasp/pytorch_networks/masks
