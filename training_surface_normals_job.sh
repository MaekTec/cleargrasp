...
#SBATCH -J cleargrasp_training_surface_normals # sets the job name. If not specified, the file name will be used as job name
...
cd /home/kaeppelm/depth-via-interaction/cleargrasp/pytorch_networks/surface_normals
srun python train.py -c config/config.yaml
