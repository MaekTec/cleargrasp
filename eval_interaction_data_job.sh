...
#SBATCH -J cleargrasp_eval_interaction_data # sets the job name. If not specified, the file name will be used as job name
...
srun python eval_depth_completion.py -c config/config_interaction_dataset.yaml
