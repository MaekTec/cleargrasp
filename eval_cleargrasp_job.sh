...
#SBATCH -J cleargrasp_eval_cleargrasp # sets the job name. If not specified, the file name will be used as job name
...
srun python eval_depth_completion.py -c config/config_real_known.yaml
srun python eval_depth_completion.py -c config/config_real_novel.yaml
srun python eval_depth_completion.py -c config/config_synthetic_known.yaml
srun python eval_depth_completion.py -c config/config_synthetic_novel.yaml
